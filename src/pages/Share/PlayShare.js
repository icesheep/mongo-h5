...
class PlayShare extends Component {
  ...
  clickChangeTime = e => {
    ...
    this.setTimeOnPc(
      ((e.pageX - this.progressDiv.clientWidth * 0.1666666667) /
        (this.progressDiv.clientWidth * 0.6666666667)) *
        duration
    );
  };
  // 开始拖动
  startChangeTime = e => {
    ...
    this.setTimeOnPc(
      ((point.pageX - this.progressDiv.clientWidth * 0.1666666667) /
        (this.progressDiv.clientWidth * 0.6666666667)) *
        duration
    );
  };
  ...
  render() {
    ...
    return (
      <div className={styles.main}>
        <div
          style={{ backgroundImage: `url("${detail && detail.imgUrl}")` }}
